...
<fusedoc fuse="dsp_ResultNav" language="ColdFusion">
	...
	<properties>
		<history email="ron@rongallant.com" type="update" date="2004-03-17" comments="now works with cfloop" />
		...
		<note author="Ron Gallant" date="2003-01-08">
			...
			<cfloop query="YourQuery" startrow="#attributes.startrow#" endrow="#attributes.endrow#"></cfoutput>
		</note>
	</properties>
	<io>
		<in>
...
<!--- Debug
<cfoutput>
#attributes.startrow#<br>
#attributes.maxrows#<br>
#attributes.EndRow#<br>
</cfoutput>
 --->
...
<table cellpadding="2" cellspacing="0" border="0" width="100%">
	<tr>
		<td align="left" colspan="2">
			...
			<cfif isDefined('attributes.application')><cfset attString = "#attString#&application=#attributes.application#"></cfif>					
			<cfif isDefined('attributes.username')><cfset attString = "#attString#&username=#attributes.username#"></cfif>
			...
			<cfif (attributes.startrow gt 1) and ( attributes.startrow+attributes.maxrows lte myQuery.recordcount)>-</cfif>

			<!--- I am the next nav --->
			<cfif attributes.startrow+attributes.maxrows lte myQuery.recordcount>
				<cfif attributes.next+attributes.maxrows gt myQuery.recordcount>
					<cfset nextcount = myQuery.recordcount-attributes.next+1>
				<cfelse>
		...
		<td align="right" colspan="3">
			...
			<cfif myQuery.recordcount gt 1>
				<div style="color:##006CDE;">There are <b>#myQuery.RecordCount#</b> entries</div>
			</cfif>
		</td>
	</tr>
</table>
