...
<table cellpadding="3" cellspacing="1" border="0" width="100%" class="TableBorder">
	...
	<tr>
		<td id="FormHeader">Application URL (if group for app)</td>
		<td>
			<input type="text" name="path" id="path" size="50" maxlength="200" value="#trim(qApp.path)#" />
		</td>
	</tr>
	<tr>
		<td id="FormHeader">Display Application link on Webutils:</td>
		<td>
	...
	<tr class="TDBackground">
		<td align="right" colspan="2">
			<cfif fusebox.fuseaction eq "New">
				<input type="button" name="Add" id="Add" value="Add Entry" class="button" style="cursor:hand;" />
			<cfelseif fusebox.fuseaction eq "Edit">
				<input type="button" name="Update" id="Update" value="Update" class="button" style="cursor:hand;" />
				
				<sec:security rights="700">
				<input type="button" name="Delete" id="Delete" value="Delete" class="button" style="cursor:hand;" />
				</sec:security>
			</cfif>
		</td>
	</tr>
