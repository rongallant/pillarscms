...
<fusedoc fuse="FBX_SaveContent.cfm">
	<responsibilities>
		I am a custom tag version of cfsavecontent's functionality. This tag was originally released as cf_bodycontent by Steve Nelson.
		This tag is required if you are using a CF server version below 5.0. 
	</responsibilities>	
	<io>
		<in>
