...
<table width="100%" cellpadding="0" cellspacing="0" border="0" height="82" style="border-bottom:1px solid ##B4B3B3">
	<tr>
		<td rowspan="2" width="57" valign="top"><img src="assets/images/spacer.gif" width="57" height="82" border="0" alt="Shell" /></td>
	...
	<tr>
		<td>
			...
			<table cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td><a href="/"><img src="assets/images/spacer.gif" width="213" height="45" border="0" alt="Logo" /></a></td>
